"""
Django settings for custos_admin_portal project.
...
ROOT_URLCONF = 'custos_admin_portal.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, "custos_admin_portal", "templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'custos_admin_portal.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, "custos_admin_portal", "static")]

LOGIN_URL = 'custos_admin_portal_auth:login'
